...
class RewardConfig(TrainingArguments):
    ...
    train_data_path: Optional[str] = field(default='rlhf/data.jsonl', metadata={"help": "训练集路径"})
    ...
    save_total_limit: Optional[int] = field(default=2, metadata={"help": "If a value is passed, will limit the total "
                                                                         ...
                                                                         "checkpoints in"})
    lr_scheduler_type: Union[SchedulerType, str] = field(default="constant_with_warmup", metadata={"help": "The "
                                                                                                           "scheduler "
                                                                                                           "type to "
                                                                                                           "use."})
    ...
    report_to: Optional[List[str]] = field(default='tensorboard', metadata={"help": "The list of integrations to "
                                                                                    "report the results and logs to."})
